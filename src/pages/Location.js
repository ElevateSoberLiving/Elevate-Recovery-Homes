    ...
    return (
        <div className="location">
            <section>
                ...
                <p>Denver is especially great for young adults. There are four major universities and multiple community colleges, along with an abundance of trade schools. In addition to a vibrant business community, an international airport, there is a thriving tourist industry with major attractions including 5 professional sport’s teams! Denver is a truly unique city</p>
            </section>
            <section> 
                <h2>Location is import</h2>
