...
function AdmissionInfo() {
    return (
        <section className="admissions__info">
            ...
            <p>The ideal Elevate Recovery member is a man who is currently substance-free and ready to take charge of his life! We look for members who still need some structure and accountability but can also handle the freedoms and temptations of semi-independent living in a large and complex city. We are not in a remote location, and everything the world has to offer is practically in our backyard or within a few hours. Combined with our intentional community design, our environment provides the right combination of challenge, support, independence, privacy, responsibility, and accountability.</p>
            <br/>
            <p>All incoming members must have some sobriety under their belt either from primary treatment, detox, or other intervention. We understand if you've had one relapse or many, we know if you are still contemplating how to live abstinent, and we understand if you aren't familiar or yet comfortable with the early stages of sobriety. While you are with us, we can work through all of those pieces together and help you elevate through the necessary steps toward abstinence.</p>
            <br/>
