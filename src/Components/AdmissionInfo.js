...
function AdmissionInfo() {
    return (
        <section className="admissions__info">
            <div className="admissions__info__head">
                <div>
                    <h2 id="main-head">ADMISSION INFORMATION</h2>
                    <hr />
                    <h2 id="second-head">TO HELP YOU GET STARTED...</h2>
                    <p>The ideal Elevate Recovery member is a man who is currently substance-free and ready to take charge of his life! Combined with our intentional community design, our environment provides the right combination of challenge, support, independence, privacy, responsibility, and accountability.</p>
                    <br />
                ...
                <img src={BryceHiking} alt="Two men hiking in the rockies." />
            </div>
